...
import { FaArrowDown } from "react-icons/fa";  // Importing the download arrow ico
                      ...
                      msg?.imageUrl && (
                        <div className='relative'>
                          <img
                            ...
                            onClick={() => handleDownload(msg?.imageUrl, 'image')}
                          />
                          <button
                            className="absolute bottom-2 left-2 p-2 bg-gray-500 text-white rounded-full text-xs"
                            onClick={() => handleDownload(msg?.imageUrl, 'image')}
                          >
                            <FaArrowDown size={16} />  {/* Using the download arrow icon */}
                          </button>
                        </div>
                      )
                    }
                      ...
                      msg?.videoUrl && (
                        <div className='relative'>
                          <video
                            ...
                            className='w-full h-full object-scale-down'
                            controls
                            onClick={() => handleDownload(msg.videoUrl, 'video')}
                          />
                          <button
                            className="absolute bottom-2 left-2 p-2 bg-gray-500 text-white rounded-full text-xs"
                            onClick={() => handleDownload(msg.videoUrl, 'video')}
